...
public class Sliding extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.gallery:
                i = new Intent(Sliding.this, testing.class);
                startActivity(i);
                return true;
            case R.id.logout:
                i = new Intent(Sliding.this, testing.class);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.gallery).setVisible(!drawerOpen);
    ...
    private void displayView(int position) {
        ...
        if (fragment != null) {
            ...
            Log.e("Sliding", "Error in creating fragment");
        }
